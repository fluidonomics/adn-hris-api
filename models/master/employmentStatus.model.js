let mongoose                = require('mongoose'),
    ...
    autoIncrement           = require('mongoose-sequence')(mongoose);
      ...
      {
        _id:{type:Number},
         employmentStatusName: {type: String,required:true,unique: true},
      ...
      EmploymentTypeSchema.pre('save', function (next) {
        var _this=this;
        if (_this.isNew) {
            mongoose.model('employmentStatus', EmploymentTypeSchema).count(function(err, c) {
                  _this._id = c + 1;
                  next();
            });
        }
     ...
     module.exports = mongoose.model('employmentStatus',EmploymentTypeSchema);
